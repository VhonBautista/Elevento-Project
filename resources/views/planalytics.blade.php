...
<div class="container mt-3">
    <div class="row">
        <div class="col-lg-7">
            <span class="text" style="font-size: 24px;">Event Analytics Report</span>
            <div class="row mt-3">
                <div class="col-md-4">
                    <div class="card">
        ...
        <div class="col-lg-5">
            <span class="text" style="font-size: 24px;">Event Rating</span>
            <div class="row mt-3">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <span class="text text-dark fw-bold" style="font-size: 16px;">Event Rating</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <span class="text text-dark fw-bold" style="font-size: 16px;">Statistic by Gender</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-4">
